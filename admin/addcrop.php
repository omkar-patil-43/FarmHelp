...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO addcrop(cropname ,climateandsoil,precultivation,seedquantityandspacing,intercroping,nutrientmanagement,irrigationsystem,weedcontrol,kidcontrol,diseasecontrol,harvestingmeasures,youtube) VALUES('$cropname','$climate','$pre','$seed','$intercroping','$nutrient','$irrigation','$weed','$kid','$disease','$harvesting','$youtube')" or die("error in query");
