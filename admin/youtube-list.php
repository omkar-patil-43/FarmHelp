...
?>
    ...
    $conn = mysqli_connect("localhost", "root", "root", "id17402499_bbdms");
        if (isset($_POST["delete"])) {
            $dat = $_POST['nam'];
            $record1 = mysqli_query($conn, "Delete from youtubevideos where videourl = '$dat'") or die("error");
            if ($record1) {
                $msg = "record deleted successfully";
            } else {
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="page-title">Youtube Videos List</h2>

                            <!-- Zero Configuration Table -->
                            <div class="panel panel-default">
                                <div class="panel-heading">Videos Info</div>
                                        ...
                                        <table id="data-table" class="table table-fixed table-striped table-bordered table-hover table-sm">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="col-xs-6">Youtube Video URL</th>
                                                    <th class="col-xs-1">Delete record</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="col-xs-6"><?php echo $data['videourl']; ?></td>
                                                        <td class="col-xs-1">
                                                            <form method="post">
                                                                <input type=text value='<?php echo ($data['videourl']) ?>' name="nam" hidden>
