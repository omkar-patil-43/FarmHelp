...
?>
    ...
    $conn = mysqli_connect("localhost", "root", "root", "id17402499_bbdms");
        if (isset($_POST["delete"])) {
            $dat = $_POST['nam'];
            $record1 = mysqli_query($conn, "Delete from scheme where filename = '$dat'") or die("error");
            if ($record1) {
                $msg = "record deleted successfully";
            } else {
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="page-title">Government Scheme List</h2>

                    <!-- Zero Configuration Table -->
                    <div class="panel panel-default">
                        <div class="panel-heading">Crops Info</div>
            ...
            <div class="d-flex">
                <div id="row-container" class="p-2 bg-white col-sm-12">
                    <table id="data-table" class="table table-fixed table-striped table-bordered table-hover table-sm">
                        <thead>
                            <tr>
                                <th class="col-xs-3">Scheme Name</th>
                                <th class="col-xs-3">Scheme link</th>
                                <th class="col-xs-3">File Name</th>
                                <th class="col-xs-3">Scheme pdf</th>
                                <th class="col-xs-3">Delete Scheme</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td class="col-xs-3"><?php echo $data['schemename']; ?></td>
                                    <td class="col-xs-3"><?php echo $data['schemelink']; ?></td>
                                    <td class="col-xs-3"><?php echo $data['filename']; ?></td>
                                    <td class="col-xs-3"><a href="data:image/pdf;charset=utf8;base64 ,<?php echo base64_encode($data['schemepdf']) ?>" download="<?php echo $data['filename']; ?>">Download<a></td>
                                    <td>
                                                            <form method="post">
